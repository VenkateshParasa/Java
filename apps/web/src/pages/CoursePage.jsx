...
function CoursePage({ course: courseProp }) {
  ...
  const seleniumFileMap = {
    '1': { week: 'week-01', file: 'day01_selenium_introduction' },
    '2': { week: 'week-01', file: 'day02_selenium_locators' },
    '3': { week: 'week-01', file: 'day03_webdriver_commands' },
    '4': { week: 'week-01', file: 'day04_web_elements' },
    '5': { week: 'week-01', file: 'day05_waits' },
    '6': { week: 'week-01', file: 'day06_dropdowns_alerts_frames' },
    '7': { week: 'week-01', file: 'day07_framework_setup_review' },
    '8': { week: 'week-02', file: 'day08_actions_class' },
    '9': { week: 'week-02', file: 'day09_drag_drop_sliders' },
    '10': { week: 'week-02', file: 'day10_web_tables' },
    '11': { week: 'week-02', file: 'day11_keyboard_operations' },
    '12': { week: 'week-02', file: 'day12_mouse_operations_advanced' },
    '13': { week: 'week-02', file: 'day13_javascript_executor' },
    '14': { week: 'week-02', file: 'day14_week2_review' },
    '15': { week: 'week-03', file: 'day15_week2_review_transition' },
    '16': { week: 'week-03', file: 'day16_screenshots_visual_testing' },
    '17': { week: 'week-03', file: 'day17_browser_options_capabilities' },
    '18': { week: 'week-03', file: 'day18_testng_part1' },
    '19': { week: 'week-03', file: 'day19_testng_part2' },
    '20': { week: 'week-03', file: 'day20_testng_part3' },
    '21': { week: 'week-03', file: 'day21_testng_part4' },
    '22': { week: 'week-03', file: 'day22_testng_part5' },
    '23': { week: 'week-04', file: 'day23_pom_part1' },
    '24': { week: 'week-04', file: 'day24_pom_part2' },
    '25': { week: 'week-04', file: 'day25_properties_files' },
    '26': { week: 'week-04', file: 'day26_excel_data_reading' },
    '27': { week: 'week-04', file: 'day27_json_csv_data' },
    '28': { week: 'week-04', file: 'day28_parallel_execution' },
    '29': { week: 'week-04', file: 'day29_cross_browser_testing' },
    '30': { week: 'week-05', file: 'day30_advanced_pom_patterns' },
    '31': { week: 'week-05', file: 'day31_external_data' },
    '32': { week: 'week-05', file: 'day32_logging_reporting_part1' },
    '33': { week: 'week-05', file: 'day33_logging_reporting_part2' },
    '34': { week: 'week-05', file: 'day34_configuration_management' },
    '35': { week: 'week-05', file: 'day35_utility_classes' },
    '36': { week: 'week-05', file: 'day36_exception_handling' },
    '37': { week: 'week-06', file: 'day37_ci_cd_integration' },
    '38': { week: 'week-06', file: 'day38_bdd_cucumber' },
    '39': { week: 'week-06', file: 'day39_api_testing_integration' },
    '40': { week: 'week-06', file: 'day40_database_testing' },
    '41': { week: 'week-06', file: 'day41_performance_security_testing' },
    '42': { week: 'week-06', file: 'day42_framework_best_practices' },
    '43': { week: 'week-07', file: 'day43_cross_browser_testing' },
    '44': { week: 'week-07', file: 'day44_mobile_web_testing' },
    '45': { week: 'week-07', file: 'day45_docker_containerization' },
    '46': { week: 'week-07', file: 'day46_cloud_testing' },
    '47': { week: 'week-07', file: 'day47_visual_regression' },
    '48': { week: 'week-07', file: 'day48_test_maintenance' },
    '49': { week: 'week-07', file: 'day49_capstone_project' }
  };
  ...
  const loadContent = async () => {
    try {
      ...
      if (course === 'selenium') {
        ...
        // Convert week1 -> week-01, week2 -> week-02, etc.
        const weekFolder = week.replace(/week(\d)$/, 'week-0$1');
        path = `/content/01_Core_Courses/Core_Java_Daily/${weekFolder}/${filename}.md`;
      }
